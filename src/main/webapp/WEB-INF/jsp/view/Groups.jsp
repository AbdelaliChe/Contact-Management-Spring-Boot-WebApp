			...
			<c:forEach items="${listGroupes}" var="Groupe">
				<tr>
					...
					<td><button type="button" class="btn btn-light btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark">
						<a href="${pageContext.request.contextPath}/contactAjoutGroupe/${Groupe.idGroupe}" style="color:inherit">Ajouter Contact</a></button></td>
					<td><button type="button" class="btn btn-light btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark">
					...
					<td><button type="button" class="btn btn-secondary btn-rounded btn-sm fw-bold"  data-mdb-ripple-color="dark">
						<a href="${pageContext.request.contextPath}/modifierFormGrp/${Groupe.idGroupe}" style="color:inherit">Modifier</a></button></td>
					<td><button type="button" class="btn btn-dark btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark">
						<a href="${pageContext.request.contextPath}/supprimerGroupe/${Groupe.idGroupe}" style="color:inherit">Supprimer</a></button></td>
				</tr>
			</c:forEach>
			</c:if>
			</tbody>
